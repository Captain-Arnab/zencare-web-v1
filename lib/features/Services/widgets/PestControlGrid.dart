...
Widget PestControlGrid({required Function(String) onServiceTap}) {
  final List<Map<String, String>> services = [
    {'title': 'Kitchen and Bathroom', 'image': 'assets/PestControl/7.png'},
    {'title': 'Apartment Pest Control (Includes Utensil Removal)', 'image': 'assets/PestControl/2.png'},
    {'title': 'Apartment Pest Control (Excludes Utensil Removal)', 'image': 'assets/PestControl/1.png'},
    {'title': 'Independent House', 'image': 'assets/PestControl/6.png'},
    {'title': 'Insect & Bug Cockroach Control Treatment', 'image': 'assets/PestControl/4.png'},
    {'title': 'Bed Bug Control', 'image': 'assets/PestControl/3.png'},
    {'title': 'Commercial Office/Shop Pest Control', 'image': 'assets/PestControl/5.png'},
  ];
